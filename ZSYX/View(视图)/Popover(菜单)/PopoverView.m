...
- (void)layoutSubviews
{
    ...
    self.tableView.layer.borderColor   = [UIColor colorWithRed:0.227 green:0.227 blue:0.282 alpha:1.000].CGColor;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.backgroundColor = [UIColor colorWithRed:0.227 green:0.227 blue:0.282 alpha:1.000];
    cell.textLabel.textAlignment = NSTextAlignmentCenter;
    //设置cell的选中状态
    cell.selectedBackgroundView = [[UIView alloc] init];
    cell.selectedBackgroundView.backgroundColor = [UIColor colorWithRed:0.227 green:0.227 blue:0.282 alpha:1.000];
...
- (void)drawRect:(CGRect)rect {
    ...
    CGContextSetStrokeColorWithColor(context, [UIColor colorWithRed:0.227 green:0.227 blue:0.282 alpha:1.000].CGColor);
    CGContextSetFillColorWithColor(context, [UIColor colorWithRed:0.227 green:0.227 blue:0.282 alpha:1.000].CGColor);
